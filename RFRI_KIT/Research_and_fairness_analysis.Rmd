...
# dt2
```
Of the 145 respondents to the survey, 126 (86.9%) filled in the responsible research practices (RRP) questionnaire. Using a cutoff score of 70, which is the half the total possible score on the RRP tool, all respondents to this questionnaire from the global south and global north passed the questions. While, for fair research practices, with the same cutoff conditions and a response rate of 116 (80%), an equal number of two individuals failed.
