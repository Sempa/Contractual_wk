...
final_dataset <- final_dataset %>%
  ...
  rowwise()%>%
  mutate(`Meticulous research process` = mean(c(rpq10, rpq12, rpq3, rpq6, rpq20), na.rm = T),
  ...
  mutate(`Engagement of local decision-makers` = mean(c(fpq2, fpq16, fpq15), na.rm = T),
...
dt01 <- final_dataset %>%
  ...
  dplyr::select(`Which country are you from?`, `What discipline of global health based describes you:`,
