...
dt01 %>%
  kable(caption = "Gender of the respondents") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$gender)))), notation = "none")
...
dt02 <- final_dataset %>%
  ...
  filter(!is.na(gender)) %>%
  summarise(
    N = n(), `Mean` = round(mean(age, na.rm = T), 2), `standard devaition` = round(sd(age, na.rm = T), 2),
    minimum = round(min(age, na.rm = T), 2), maximum = max(age, na.rm = T)
  )
dt02 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$age)))), notation = "none")
...
dt03 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$take_meds_regularly_Hypertention)))), notation = "none")
...
dt04 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$take_meds_regularly_Diabetes_mellitus)))), notation = "none")
...
dt05 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$take_meds_regularly_High_blood_cholesterol)))), notation = "none")
...
dt06 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$take_meds_regularly_other)))), notation = "none")
...
dt07 <- final_dataset %>%
  ...
  filter(!is.na(take_meds_regularly_others_specify)) %>%
  separate(col = `take_meds_regularly_others_specify`,
           sep = ',',
  ...
  pivot_longer(cols = c(col1, col2, col3),
               names_to = 'col_num',
               values_to = 'take_meds_regularly_others_specify') %>%
  filter(!is.na(take_meds_regularly_others_specify)) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$diagnosed_physical_health_condition)))), notation = "none")
# 
# dt09 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$diagnosed_physical_health_condition_specify)))), notation = "none")
# 
# dt10 <- final_dataset %>%
#   filter(visit == 0) %>%
#   # mutate(take_meds_regularly_other = ifelse(take_meds_regularly_other=='y', 'Y', take_meds_regularly_other)) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$trt_physical_health_condition)))), notation = "none")
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$problems_with_meds)))), notation = "none")
#
# dt14 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$problems_with_meds_details)))), notation = "none")
#
# dt15 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$need_information_about_meds)))), notation = "none")
#
# dt17 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$disability_impairment)))), notation = "none")
#
# dt18 <- final_dataset %>%
#   filter(visit == 0) %>%
#   # filter(disability_impairment=='Y') %>%
...
dt19 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$family_history_heartdiseasespecify)))), notation = "none")
...
dt21 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$family_history_stroke)))), notation = "none")
...
dt23 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$family_history_cancer)))), notation = "none")
...
dt25 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$family_history_HTNorHBP)))), notation = "none")
...
dt26 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'repeat_header')) #%>%
  # kabel_styling(latex_options = 'scale_down')
...
dt27 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$family_history_diabetes)))), notation = "none")
...
dt29 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$think_you_eat_healthy_diet)))), notation = "none")
...
<!--   kable_classic(full_width = F, html_font = "Arial")%>% -->
<!--   kable_styling(latex_options = "HOLD_position") %>% -->
<!--   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`8. How many meals have you had yesterday?`)))), notation = "none") -->
...
<!--   kable_classic(full_width = F, html_font = "Arial")%>% -->
<!--   kable_styling(latex_options = "HOLD_position") %>% -->
<!--   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`9. At what time have you had meal 1`)))), notation = "none") -->
...
<!--   kable_classic(full_width = F, html_font = "Arial")%>% -->
<!--   kable_styling(latex_options = "HOLD_position") %>% -->
<!--   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`10. At what time have you had meal 2`)))), notation = "none") -->
...
<!--   kable_classic(full_width = F, html_font = "Arial")%>% -->
<!--   kable_styling(latex_options = "HOLD_position") %>% -->
<!--   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`11. At what time have you had meal 3`)))), notation = "none") -->
...
<!--   kable_classic(full_width = F, html_font = "Arial")%>% -->
<!--   kable_styling(latex_options = "HOLD_position") %>% -->
<!--   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`12. At what time have you had meal 4`)))), notation = "none") -->
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`do you take part in any physical activity or exercise`)))), notation = "none")
# 
# dt37 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`if yes what do you do and how often`)))), notation = "none")
# 
dt38 <- final_dataset %>%
  filter(visit == 0) %>%
...
dt38 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`1.7 Do you smoke tobacco?`)))), notation = "none")
...
dt39 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`14. how many cigarettes do you smoke per day?`)))), notation = "none")

dt40 <- final_dataset %>%
  filter(visit == 0) %>%
  separate(col = `15. should you smoke or use tabacco in any other form, please elaborate`,
           sep = ',',
           into = c('col1', 'col2', 'col3'),
    remove = FALSE
    ) %>%
  ...
  pivot_longer(cols = c(col1, col2, col3),
               names_to = 'col_num',
               values_to = '15. should you smoke or use tabacco in any other form, please elaborate') %>%
  filter(!is.na(`15. should you smoke or use tabacco in any other form, please elaborate`)) %>%
  filter(!is.na(`15. should you smoke or use tabacco in any other form, please elaborate`)) %>%
  mutate(`other forms of tobacco usage` = ifelse(`15. should you smoke or use tabacco in any other form, please elaborate`==' ROLLED CIGARETTES', 'ROLLED CIGARETTES', `15. should you smoke or use tabacco in any other form, please elaborate`)) %>%
  group_by(`other forms of tobacco usage`) %>%
  summarise(Freq = n()) %>%
  mutate(
    percentage = round((Freq / (sum(Freq))) * 100, 1), `cumulative frequency` = cumsum(Freq),
    `cumulative percentage` = cumsum(percentage)
...
dt40 %>%
  ...
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'scaled_down')) %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`15. should you smoke or use tabacco in any other form, please elaborate`)))), notation = "none")
...
dt41 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") #%>%
  # add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`16. if no, have you smoked in the past`)))), notation = "none")
...
dt42 %>%
  kable(caption = "17. If yes, when did you quit?") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`17. If yes, when did you quit?`)))), notation = "none")
...
dt43 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`1.8 Do you drink alcohol?`)))), notation = "none")
...
dt44 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & final_dataset$`1.8 Do you drink alcohol?`=='Y' & is.na(final_dataset$`If yes, how often have you had 6 or more units (female), or 8 or more (male), on a single occasion in the last year?`)))), notation = "none")
...
#   )
# dt45 %>%
#   kable(caption = "are you aware of the recommended mazimum units of alcoho; per day?") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`are you aware of the recommended mazimum units of alcoho; per day?`)))), notation = "none")
# 
# dt46 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt46 %>%
#   kable(caption = "if no, would you like more information in this?") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`if no, would you like more information in this?`)))), notation = "none")

dt47 <- final_dataset %>%
  filter(visit == 0) %>%
  mutate(`1.9 Do you use drugs?` = ifelse(`1.9 Do you use drugs?`=='n', 'N', `1.9 Do you use drugs?`)) %>%
  # mutate(`1.9 Do you use drugs?` = ifelse(!is.na(`20. If YES, what do you use?`), 'Y', `1.9 Do you use drugs?`)) %>%
...
dt47 %>%
  kable(caption = "1.9 Do you use drugs?") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`1.9 Do you use drugs?`)))), notation = "none")

dt48 <- final_dataset %>%
  filter(visit == 0) %>%
  filter(`1.9 Do you use drugs?`=='Y') %>%
  filter(!is.na(`20. If YES, what do you use?`)) %>%
  separate(col = `20. If YES, what do you use?`,
           sep = ',',
           into = c('col1', 'col2', 'col3'),
    remove = FALSE
    ) %>%
  ...
  pivot_longer(cols = c(col1, col2, col3),
               names_to = 'col_num',
               values_to = '20. If YES, what do you use?') %>%
  filter(!is.na(`20. If YES, what do you use?`)) %>%
  mutate(`20. If YES, what do you use?`= ifelse(`20. If YES, what do you use?`=='Dagga', 'DAGGA', `20. If YES, what do you use?`)) %>%
  mutate(`20. If YES, what do you use?`= ifelse(`20. If YES, what do you use?`==' TIK', 'TIK', `20. If YES, what do you use?`)) %>%
...
dt48 %>%
  kable(caption = "20. If YES, what do you use?") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`20. If YES, what do you use?`)))), notation = "none")
...
dt49 %>%
  kable(caption = "21. How often do you use these drug or drugs per week?") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'scale_down')) %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`21. How often do you use these drug or drugs per week?`)))), notation = "none")
...
dt50 %>%
  kable(caption = "stopped using drugs mentioned in 19.") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`stopped using drugs mentioned in 19.`)))), notation = "none")
...
dt51 %>%
  kable(caption = "22.Were you ever diagnosed with diabetes during pregnancy? (females):") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`22.  Were you ever diagnosed with diabetes during pregnancy? (females):`)))), notation = "none")
...
dt52 %>%
  kable(caption = "23. How many years of your life have you spent in the city?") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`23. How many years of your life have you spent in the city?`)))), notation = "none")
...
dt53 %>%
  kable(caption = "24. Improving diet") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`24.  information and support on_improvingdiet`)))), notation = "none")
...
dt54 %>%
  kable(caption = "24. Increase physical activity") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'scale_down')) %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`24.  information and support on_increasephysicalactivity`)))), notation = "none")
...
dt55 %>%
  kable(caption = "24.Stoping or reducing smoking") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'scale_down')) %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`24.  information and support on_stopingreducingsmoking`)))), notation = "none")
...
dt56 %>%
  kable(caption = "24. reduce alcohol in-take") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'scale_down')) %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`24.  information and support on_reducealcoholintake`)))), notation = "none")
...
dt57 %>%
  kable(caption = "24. Stoping reducing drug usage") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'scale_down')) %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`24.  information and support on_stopreducedrugs`)))), notation = "none")
...
#   )
# dt58 %>%
#   kable(caption = "symptoms checklist increased thirst") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_increasedthirst`)))), notation = "none")
# 
# dt59 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt59 %>%
#   kable(caption = "symptoms checklist urination") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_urination`)))), notation = "none")
# 
# dt60 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt60 %>%
#   kable(caption = "symptoms checklist breathlessness") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_breathlessness`)))), notation = "none")
# 
# dt61 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt61 %>%
#   kable(caption = "symptoms checklist unexpected weight gain") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_unexpectedweightgain`)))), notation = "none")
# 
# dt62 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt62 %>%
#   kable(caption = "symptoms checklist unexpected weight loss") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_unexpectedweightloss`)))), notation = "none")
# 
# dt63 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt63 %>%
#   kable(caption = "symptoms checklist fits blackout") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_fitsblackouts`)))), notation = "none")
# 
# dt64 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt64 %>%
#   kable(caption = "symptoms checklist constipation") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_constipation`)))), notation = "none")
# 
# dt65 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt65 %>%
#   kable(caption = "symptoms checklist difficulty having sex") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_diffhavingsex`)))), notation = "none")
# 
# dt66 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt66 %>%
#   kable(caption = "symptoms checklist chest pain") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_chestpain`)))), notation = "none")
# 
# dt67 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt67 %>%
#   kable(caption = "symptoms checklist difficulty sleeping") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_difficultiessleeping`)))), notation = "none")
# 
# dt68 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt68 %>%
#   kable(caption = "symptoms checklist loss sensation feet") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`symptoms checklist_losssensationfeet`)))), notation = "none")
...
#   )
# dt69 %>%
#   kable(caption = "when last did you visit your clinic?") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`when last did you visit your clinic?`)))), notation = "none")
# 
# dt70 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt70 %>%
#   kable(caption = "reason for visit or results of test") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`reason for visit or results of test`)))), notation = "none")
# 
# dt71 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   )
# dt71 %>%
#   kable(caption = "When last did you visit your doctor?") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`when last did you visit your doctor?`)))), notation = "none")
# 
# dt72 <- final_dataset %>%
#   filter(visit == 0) %>%
#   filter(!is.na(`when last did you visit your doctor?`)) %>%
...
dt73 %>%
  kable(caption = "difficulty concentrating") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`difficulty concentrating`)))), notation = "none")
...
dt74 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`pain`)))), notation = "none")
...
dt75 %>%
  kable(caption = "lack of energy") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`lack of energy`)))), notation = "none")
...
dt76 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`cough`)))), notation = "none")
...
dt77 %>%
  kable(caption = "changes in skin") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`changes in skin`)))), notation = "none")
...
dt78 %>%
  kable(caption = "dry mouth") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`dry mouth`)))), notation = "none")

dt79 <- final_dataset %>%
  filter(visit == 0) %>%
  filter(!is.na(`nausea`)) %>%
  mutate(`nausea` = ifelse(`nausea`=='NN', 'N', `nausea`)) %>%
  group_by(`nausea`) %>%
  summarise(Freq = n()) %>%
  mutate(
    percentage = round((Freq / (sum(Freq))) * 100, 1), `cumulative frequency` = cumsum(Freq),
...
dt79 %>%
  kable(caption = "nausea") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`nausea`)))), notation = "none")
...
dt80%>%
  kable(caption = "feeling drowsy") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`feeling drowsy`)))), notation = "none")
...
dt81 %>%
  kable(caption = "numbness or tingling in hands and feet") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`numbness_tingling in hands and feet`)))), notation = "none")
...
dt82 %>%
  kable(caption = "difficulty sleeping") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`difficulty sleeping`)))), notation = "none")
...
dt83 %>%
  kable(caption = "feeling bloated") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`feeling bloated`)))), notation = "none")
...
dt84 %>%
  kable(caption = "problems with urination") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`problems with urination`)))), notation = "none")
...
dt85 %>%
  kable(caption = "vomiting") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`vomiting`)))), notation = "none")
...
dt86 %>%
  kable(caption = "shortness of breath") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`shortness of breath`)))), notation = "none")
...
dt87 %>%
  kable(caption = "diarrhea") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`diarrhea`)))), notation = "none")
...
dt88 %>%
  kable(caption = "sweats") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`sweats`)))), notation = "none")
...
dt89 %>%
  kable(caption = "mouth sores") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`mouth sores`)))), notation = "none")
...
dt90 %>%
  kable(caption = "problems with sexual interest or activity") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`problems with sexual interest or activity`)))), notation = "none")
...
dt91 %>%
  kable(caption = "itching") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`itching`)))), notation = "none")
...
dt92 %>%
  kable(caption = "lack of appetite") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`lack of appetite`)))), notation = "none")
...
dt93 %>%
  kable(caption = "dizziness") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`dizziness`)))), notation = "none")
...
dt94 %>%
  kable(caption = "difficulty swallowing") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`difficulty swallowing`)))), notation = "none")
...
dt95 %>%
  kable(caption = "change in the way food taste") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`change in the way food taste`)))), notation = "none")
...
dt96 %>%
  kable(caption = "weight loss") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`weight loss`)))), notation = "none")
...
dt91 %>%
  kable(caption = "hair loss") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`hair loss`)))), notation = "none")
...
dt92 %>%
  kable(caption = "constipation") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`constipation`)))), notation = "none")
...
dt93 %>%
  kable(caption = "swelling of arms or legs") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`swelling of arms or legs`)))), notation = "none")
...
dt94 %>%
  kable(caption = "i don't look like myself") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`i don't look like myself`)))), notation = "none")
...
dt95 %>%
  kable(caption = "any other symptoms during the past week?") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`any other symptoms during the past week?`)))), notation = "none")
...
dt96 %>%
  kable(caption = "any other symptom specify") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = c("HOLD_position", 'repeat_header')) %>%
  kable_styling(latex_options="scale_down") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`any_other_symptom_specify`)))), notation = "none")
...
dt97 %>%
  kable(caption = "commonly listed symptoms feeling sad") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`commonly_listed_symptoms_feelingsad`)))), notation = "none")
...
dt98 %>%
  kable(caption = "commonly listed symptoms worrying") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`commonly_listed_symptoms_worrying`)))), notation = "none")
...
dt99 %>%
  kable(caption = "commonly listed symptoms feeling irritable") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`commonly_listed_symptoms_feelingirritable`)))), notation = "none")
...
dt100 %>%
  kable(caption = "commonly listed symptoms feeling nervous") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`commonly_listed_symptoms_feelingnervous`)))), notation = "none")
...
dt101 %>%
  kable(caption = "At what age were you diagnosed with diabetes") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`diabetes_age`)))), notation = "none")
...
dt102 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_age`)))), notation = "none")

dt103 <- final_dataset %>%
  filter(visit == 0) %>%
  mutate(`type2Diabetes_BMI` = ifelse(`type2Diabetes_BMI`=='ERROR 2', '', `type2Diabetes_BMI`)) %>%
...
dt103 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_BMI`)))), notation = "none")
...
dt104 %>%
  kable(caption = "waist circumfrance - men") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_waistCircum_men`)))), notation = "none")
...
dt105 %>%
  kable(caption = "waist circumfrance - women") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_waistCircum_women`)))), notation = "none")
...
dt106 %>%
  kable(caption = "30 mins of physical activities") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_physicalactivities`)))), notation = "none")
...
dt107 %>%
  kable(caption = "Eating vegetable fruits and berries") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_eatvegsfruitsberries`)))), notation = "none")
...
dt108 %>%
  kable(caption = "taken meds for high blood pressure") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_medsforHBP`)))), notation = "none")
...
dt109 %>%
  kable(caption = "have you ever been found to have high blood pressure") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_foundtohaveHBG`)))), notation = "none")
...
dt110 %>%
  kable(caption = "immediate family been diagnosed with diabetes") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_diabetes`)))), notation = "none")
...
dt111 %>%
  kable(caption = "which immediate family members diagnosed with diabetes") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`type2Diabetes_familyhistorydiabetes`)))), notation = "none")
...
dt112 %>%
  kable(caption = "Temperature") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`temperature`)))), notation = "none")
...
dt113 %>%
  kable(caption = "has the subject fasted at least since 22:00?") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`has the subject fasted at least since 22:00?`)))), notation = "none")
...
dt114 <- final_dataset %>%
  ...
  summarise(
    N = n(),
    Mean = round(mean(`fasting capillary glucose(finger prick)`, na.rm = T), 2),
    `Std. deviation` = round(sd(`fasting capillary glucose(finger prick)`, na.rm = T), 2),
    Minimum = min(`fasting capillary glucose(finger prick)`, na.rm = T),
    Maximum = max(`fasting capillary glucose(finger prick)`, na.rm = T)
  )
dt114 %>%
  kable(caption = "fasting capillary glucose(finger prick)") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`fasting capillary glucose(finger prick)`)))), notation = "none")
...
dt115 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_leucocytes`)))), notation = "none")
...
dt116 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_nitrite`)))), notation = "none")
...
dt117 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_urobilinogen`)))), notation = "none")
...
dt118 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_protein`)))), notation = "none")
...
dt119 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_pH`)))), notation = "none")
...
dt120 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_blood`)))), notation = "none")
...
dt121 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_specificgravity`)))), notation = "none")
...
dt122 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_ketones`)))), notation = "none")
...
dt123 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_bilirubin`)))), notation = "none")
...
dt124 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`urineMultistix_glucose`)))), notation = "none")
...
dt125 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`heigth`)))), notation = "none")
...
dt126 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`Weight`)))), notation = "none")
...
dt127 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`waist circumference`)))), notation = "none")
...
dt128 %>%
  kable(caption = "Mid-arm circumfrance") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`midarm circumfrance`)))), notation = "none")
...
dt129 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$omronBodycomposition_BMI)))), notation = "none")
...
dt130 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$omronBodycomposition_bodyfat)))), notation = "none")
...
dt131 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$omronBodycomposition_bodywater)))), notation = "none")
...
dt132 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$omronBodycomposition_visaerakfat)))), notation = "none")
...
dt133 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$omronBodycomposition_metabolicrate)))), notation = "none")
...
dt134 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$omronBodycomposition_muscle)))), notation = "none")
...
dt134 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$bloodpressuresmin_sbp1)))), notation = "none")

dt135 <- final_dataset %>%
  filter(visit == 0) %>%
  filter(!is.na(`bloodpressuresmin_dbp1`)) %>%
  # mutate(bloodpressuresmin_dbp1 = `bloodpressuresmin_dbp1`) %>%
  summarise(
    N = n(),
...
dt135 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$bloodpressuresmin_dbp1)))), notation = "none")

dt136 <- final_dataset %>%
  filter(visit == 0) %>%
  filter(!is.na(bloodpressuresmin_sbp2)) %>%
  # mutate(bloodpressuresmin_sbp2 = `bloodpressuresmin_sbp2`) %>%
  summarise(
    N = n(),
...
dt136 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$bloodpressuresmin_sbp2)))), notation = "none")
...
dt137 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$bloodpressuresmin_dbp2)))), notation = "none")
...
dt138 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$bloodpressuresmin_sbp3...212)))), notation = "none")

dt139 <- final_dataset %>%
  filter(visit == 0) %>%
  filter(!is.na(bloodpressuresmin_dbp3)) %>%
  # mutate(bloodpressuresmin_dbp3 = `bloodpressuresmin_sbp3...213`) %>%
  summarise(
    N = n(),
...
dt139 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$bloodpressuresmin_sbp3...213)))), notation = "none")
...
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_heart rate1`)))), notation = "none")
# 
# dt141 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = c("HOLD_position", "repeat_header", 'scale_down')) %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm1_1`)))), notation = "none")
# 
# dt142 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = c("HOLD_position", "repeat_header", 'scale_down')) %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm2_1`)))), notation = "none")
# 
# dt143 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = c("HOLD_position", "repeat_header", 'scale_down')) %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm3_1`)))), notation = "none")
# 
# dt144 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = c("HOLD_position", "repeat_header", 'scale_down')) %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm4_1`)))), notation = "none")
# 
# dt145 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_results1`)))), notation = "none")
# 
# dt146 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_unconfirmedreport1`)))), notation = "none")
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_heart rate2`)))), notation = "none")
# 
# dt148 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm1_2`)))), notation = "none")
# 
# dt149 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm2_2`)))), notation = "none")
# 
# dt150 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm3_2`)))), notation = "none")
# 
# dt151 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm4_2`)))), notation = "none")
# 
# dt152 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_results2`)))), notation = "none")
# 
# dt153 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_unconfirmedreport2`)))), notation = "none")
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_heart rate3`)))), notation = "none")
# 
# dt155 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm1_3`)))), notation = "none")
# 
# dt156 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm2_3`)))), notation = "none")
# 
# dt157 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm3_3`)))), notation = "none")
# 
# dt158 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_sinus rhythm4_3`)))), notation = "none")
# 
# dt157 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_results3`)))), notation = "none")
# 
# dt158 <- final_dataset %>%
#   filter(visit == 0) %>%
...
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`ECG_unconfirmedreport3`)))), notation = "none")
...
dt159 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS haematology HB") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_haematology_HB)))), notation = "none")
...
dt160 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS chemicalpathology creatinine") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_chemicalpathology_creatinine)))), notation = "none")
...
dt161 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS glucose Fasting") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_glucoseFasting)))), notation = "none")
...
dt162 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS glucose 30 min") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_glucose30min)))), notation = "none")
...
dt163 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS blood Chem glucose 120min") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_bloodChem_glucose120min)))), notation = "none")
...
dt164 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS blood Chem insulin Fasting") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_bloodChem_insulinFasting)))), notation = "none")
...
dt165 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS blood Chem insulin 30min") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_bloodChem_insulin30min)))), notation = "none")
...
dt166 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS blood Chem insulin 120min") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_bloodChem_insulin120min)))), notation = "none")
...
dt167 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS HbA1C NGSP") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_HbA1_NGSP)))), notation = "none")
...
dt168 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS HbA1C IFCC") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_HbA1C_IFCC)))), notation = "none")
...
dt169 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS HbA1C eAG") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_HbA1C_eAG)))), notation = "none")
...
dt170 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS uricacid") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_uricacid)))), notation = "none")
...
dt171 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS lipids total cholestrol") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_lipids_totalcholestrol)))), notation = "none")
...
dt172 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS lipids triglyceride") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_lipids_triglyceride)))), notation = "none")
...
dt173 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS lipids HDL cholesterol") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_lipids_HDLcholesterol)))), notation = "none")
...
dt174 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS lipids LDL cholesterol") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_lipids_LDLcholesterol)))), notation = "none")
...
dt175 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS haematinics Ferritin") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_haematinicsFerritin)))), notation = "none")
...
dt176 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS serum HBindex") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_serumHBindex)))), notation = "none")
...
dt177 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS serum Bilirubinindex") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_serumBilirubinindex)))), notation = "none")
...
dt178 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS serum lipidaemia index") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_serumlipaemiaIndex)))), notation = "none")
...
dt179 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS urine creatinine") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_urine_creatinine)))), notation = "none")
...
dt180 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS urine albumin") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_urine_albumin)))), notation = "none")
...
dt181 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS urine albumin Creatratio") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_urinealbuminCreatratio)))), notation = "none")
...
dt182 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS urine Protein") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_urineProtein)))), notation = "none")
...
dt183 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_urineProteinCreatratio)))), notation = "none")
...
# 
# dt184 %>%
#   kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS ferritin") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_ferritin)))), notation = "none")
# 
# dt185 <- final_dataset %>%
#   filter(visit == 0) %>%
...
# dt185 %>%
#   kable(booktabs = TRUE, longtable = TRUE, caption = "NHLS hb") %>%
#   kable_paper("hover", full_width = F) %>%
#   kable_classic(full_width = F, html_font = "Arial")%>%
#   kable_styling(latex_options = "HOLD_position") %>%
#   add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$NHLS_hb)))), notation = "none")
# 
...
dt186 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Respondents occupation") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`occupation`)))), notation = "none")
...
dt187 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Respondents marital Status") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`maritalStatus`)))), notation = "none")

dt188 <- final_dataset %>%
  filter(visit == 0) %>%
  filter(!is.na(`number of dependants`)) %>%
  group_by(`number of dependants`) %>%
  summarise(Freq = n()) %>%
  mutate(
    percentage = round((Freq / (sum(Freq))) * 100, 1), `cumulative frequency` = cumsum(Freq),
    `cumulative percentage` = cumsum(percentage)
...
dt188 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "number of dependants") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`number of dependants`)))), notation = "none")
...
dt189 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "home language") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`home language`)))), notation = "none")
...
dt191 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest: what is HIV or AIDS") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_whatisHIVAIDS`)))), notation = "none")
...
dt192 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest it has been explained to you how the test is done") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_it has been explained to you how the test is done`)))), notation = "none")
...
dt193 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest the advantages of the test been explained to you") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_the advantages of the test been explained to you`)))), notation = "none")
...
dt194 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest the disadvantages of the test been explained to you") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_the disadvantages of the test been explained to you`)))), notation = "none")
...
dt195 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest it has been explianed to you") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_it has been explianed to you`)))), notation = "none")
...
dt196 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest what a negative result means") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_what a negative result means`)))), notation = "none")
...
dt197 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest what is meant by the window period") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_what is meant by the window period`)))), notation = "none")
...
dt198 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest the importance of positive living") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_the importance of positive living`)))), notation = "none")
...
dt199 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest it has been explianed what shared") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_it has been explianed what shared`)))), notation = "none")
...
dt200 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest available resources for positive") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_available resources for positive`)))), notation = "none")
...
dt201 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "rapidtest the importance of disclosing my HIV status") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_the importance of disclosing my`)))), notation = "none")
...
dt202 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Tbscreening coughfor morethan 2 weeks") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`Tbscreening_coughfor morethan 2 weeks`)))), notation = "none")
...
dt203 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Tbscreening unexplianed weight loss") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`Tbscreening_unexplianed weight loss`)))), notation = "none")
...
dt204 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Tbscreening night sweats") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`Tbscreening_night sweats`)))), notation = "none")
...
dt204 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Tbscreening loss of appetite") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`Tbscreening_loss of appetite`)))), notation = "none")
...
dt205 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "Tbscreening fever of unexplianed origin") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`Tbscreening_fever of unexplianed origin`)))), notation = "none")
...
dt206 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`rapidtest_done`)))), notation = "none")
...
dt207 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Gender") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_gender`)))), notation = "none")
...
dt208 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Temperature") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_temperature`)))), notation = "none")
...
dt209 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Fever") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_fever`)))), notation = "none")
...
dt210 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Sore throat") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_sorethroat`)))), notation = "none")
...
dt211 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Cough") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_cough`)))), notation = "none")
...
dt211 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 Chills") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_chills`)))), notation = "none")
...
dt212 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening difficult breathing") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_difficult breathing`)))), notation = "none")
...
dt213 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Diarrhoea") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_diarrhoea`)))), notation = "none")
...
dt214 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Diabetes") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_diabetes"`)))), notation = "none")
...
dt215 %>%
  ...
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_asthma`)))), notation = "none")
...
dt216 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening High blood pressure") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_highbloodpressure`)))), notation = "none")
...
dt217 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Respiratory illness") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_respiratory illness`)))), notation = "none")
...
dt218 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Cancer") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_cancer`)))), notation = "none")
...
dt219 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Travel to other provinces") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_recent travel to other provinces`)))), notation = "none")
...
dt220 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening contact with confirmed COVID19") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_any contact with confirmed covid19`)))), notation = "none")
...
dt221 %>%
  kable(booktabs = TRUE, longtable = TRUE, caption = "COVID-19 screening Where you admited to hospital") %>%
  kable_paper("hover", full_width = F) %>%
  kable_classic(full_width = F, html_font = "Arial")%>%
  kable_styling(latex_options = "HOLD_position") %>%
  add_footnote(paste0('missing = ', length(which(final_dataset$visit == 0 & is.na(final_dataset$`covid_where you admited at hospital`)))), notation = "none")
