...
table6 <- final_dataset %>%
  filter(visit == 0) %>%
  mutate(`Difficulty concentrating` = ifelse(`difficulty concentrating` =='1' | `difficulty concentrating` =='2' | `difficulty concentrating` == '3' | `difficulty concentrating` == '4' |
                                             `difficulty concentrating` == 'Y', 'Y', `difficulty concentrating`),
         `Pain` = ifelse(`pain` =='1' | `pain` =='2' | `pain` == '3' | `pain` == '4' |
                                             `pain` == 'Y', 'Y', `pain`),
         `Lack of energy` = ifelse(`lack of energy` =='1' | `lack of energy` =='2' | `lack of energy` == '3' | `lack of energy` == '4' | `lack of energy` == 'Y', 'Y', `lack of energy`),
         `Cough` = ifelse(`cough` =='1' | `cough` =='2' | `cough` == '3' | `cough` == '4' |
                                             `cough` == 'Y', 'Y', `cough`),
         `Changes in skin` = ifelse(`changes in skin` =='1' | `changes in skin` =='2' | `changes in skin` == '3' | `changes in skin` == '4' | `changes in skin` == 'Y', 'Y', `changes in skin`),
         `Dry mouth` = ifelse(`dry mouth` =='1' | `dry mouth` =='2' | `dry mouth` == '3' | `dry mouth` == '4' | `dry mouth` == 'Y', 'Y', `dry mouth`),
         `Nausea` = ifelse(`nausea` =='1' | `nausea` =='2' | `nausea` == '3' | `nausea` == '4' | `nausea` == 'Y', 'Y', ifelse(`nausea` == 'NN' | `nausea` == 'N', 'N', `nausea`)),
         `Feeling drowsy` = ifelse(`feeling drowsy` =='1' | `feeling drowsy` =='2' | `feeling drowsy` == '3' | `feeling drowsy` == '4' | `feeling drowsy` == 'Y', 'Y', `feeling drowsy`),
         `Numbness_tingling in hands and feet` = ifelse(`numbness_tingling in hands and feet` =='1' | `numbness_tingling in hands and feet` =='2' | `numbness_tingling in hands and feet` == '3' | `numbness_tingling in hands and feet` == '4' | `numbness_tingling in hands and feet` == 'Y', 'Y', `numbness_tingling in hands and feet`)
         ) %>%
...
table7 <- final_dataset %>%
  filter(visit == 0) %>%
  mutate(`Difficulty sleeping` = ifelse(`difficulty sleeping` =='1' | `difficulty sleeping` =='2' | `difficulty sleeping` == '3' | `difficulty sleeping` == '0' | `difficulty sleeping` == '4' | `difficulty sleeping` == 'Y', 'Y', `difficulty sleeping`),
         `Feeling bloated` = ifelse(`feeling bloated` =='1' | `feeling bloated` =='2' | `feeling bloated` == '3' | `feeling bloated` == '0' | `feeling bloated` == '4' | `feeling bloated` == 'Y', 'Y', `feeling bloated`),
         `Problems with urination` = ifelse(`problems with urination` =='1' | `problems with urination` =='2' | `problems with urination` == '3' | `problems with urination` == '0' | `problems with urination` == '4' | `problems with urination` == 'Y', 'Y', `problems with urination`),
         `Vomiting` = ifelse(`vomiting` =='1' | `vomiting` =='2' | `vomiting` == '3' | `vomiting` == '0' | `vomiting` == '4' | `vomiting` == 'Y', 'Y', `vomiting`),
         `Shortness of breath` = ifelse(`shortness of breath` =='1' | `shortness of breath` =='2' | `shortness of breath` == '3' | `shortness of breath` == '0' | `shortness of breath` == '4' | `shortness of breath` == 'Y', 'Y', `shortness of breath`),
         `Diarrhea` = ifelse(`diarrhea` =='1' | `diarrhea` =='2' | `diarrhea` == '3' | `diarrhea` == '0' | `diarrhea` == '4' | `diarrhea` == 'Y', 'Y', `diarrhea`),
         `Sweats` = ifelse(`sweats` =='1' | `sweats` =='2' | `sweats` == '3' | `sweats` == '0' | `sweats` == '4' | `sweats` == 'Y', 'Y', `sweats`),
         `Mouth sores` = ifelse(`mouth sores` =='1' | `mouth sores` =='2' | `mouth sores` == '3' | `mouth sores` == '0' | `mouth sores` == '4' | `mouth sores` == 'Y', 'Y', `mouth sores`),
         `Problems with sexual interest or activity` = ifelse(`problems with sexual interest or activity` =='1' | `problems with sexual interest or activity` =='2' | `problems with sexual interest or activity` == '3' | `problems with sexual interest or activity` == '0' | `problems with sexual interest or activity` == '4' | `problems with sexual interest or activity` == 'Y', 'Y', `problems with sexual interest or activity`),
         `Itching` = ifelse(`itching` =='1' | `itching` =='2' | `itching` == '3' | `itching` == '0' | `itching` == '4' | `itching` == 'Y', 'Y', `itching`)
         ) %>%
...
table8 <- final_dataset %>%
  ...
  mutate(`Lack of appetite` = ifelse(`lack of appetite` =='1' | `lack of appetite` =='2' | `lack of appetite` == '3' | `lack of appetite` == '0' | `lack of appetite` == '4' | `lack of appetite` == 'Y', 'Y', `lack of appetite`),
         ...
         `Change in the way food taste` = ifelse(`change in the way food taste` =='1' | `change in the way food taste` =='2' | `change in the way food taste` == '3' | `change in the way food taste` == '0' | `change in the way food taste` == '4' | `change in the way food taste` == 'Y', 'Y', `change in the way food taste`),
         `Weight loss` = ifelse(`weight loss` =='1' | `weight loss` =='2' | `weight loss` == '3' | `weight loss` == '0' | `weight loss` == '4' | `weight loss` == 'Y', 'Y', `weight loss`),
         `Hair loss` = ifelse(`hair loss` =='1' | `hair loss` =='2' | `hair loss` == '3' | `hair loss` == '0' | `hair loss` == '4' | `hair loss` == 'Y', 'Y', `hair loss`),
         `Constipation` = ifelse(`constipation` =='1' | `constipation` =='2' | `constipation` == '3' | `constipation` == '0' | `constipation` == '4' | `constipation` == 'Y', 'Y', `constipation`),
...
table12 <- final_dataset %>%
  filter(visit == 0) %>%
  mutate(`Type II Diabetes: BMI` = ifelse(`type2Diabetes_BMI`=='ERROR 2', '', `type2Diabetes_BMI`),
