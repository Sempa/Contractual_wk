...
final_dataset<- final_dataset %>%
  left_join(read_excel("Updated OI's  05 March 2024.xlsx") %>%
              dplyr::select(`Hospital folder number`, `Opportunistic infection  (choice=Tuberculosis)`, `Opportunistic infection  (choice=Cryptococcus neoformans)`, `Opportunistic infection  (choice=Pneumonia)`, `Opportunistic infection  (choice=Staph aureus)`, `Opportunistic infection  (choice=Kaposis sarcoma)`, `Opportunistic infection  (choice=Cytomegalovirus)`, `Opportunistic infection  (choice=HSV)`, `Opportunistic infection  (choice=HepB)`, `Opportunistic infection  (choice=Candida)`, `Opportunistic infection  (choice=Other)`, `Opportunistic infection  (choice=GE / C diff)`, `Opportunistic infection  (choice=Parvo B19)`, `Opportunistic infection  (choice=Syphilis)`, `Opportunistic infection  (choice=B menigitis)`, `Opportunistic infection  (choice=UTI / Leptospirosis)`, `Opportunistic infection  (choice=PCP)`, `Opportunistic infection  (choice=covid)`, `Opportunistic infection  (choice=Neurocysticercosis)`), by = 'Hospital folder number')
...
table_1 <- final_dataset %>%
  ...
  dplyr::select(`Age at enrolment`, gender, Ethnicity, `Duration of current illness`, `Opportunistic infection present`, `log10 viral load`, `Total CD4 count...10`, #Sodium, Potassium, Haemoglobin, `White cell count`, `Lymphocyte count`, Neutrophils, `Addisons disease`,
                `Tuberculosis`, `Cryptococcus neoformans`, `Toxoplasmosis`, `Mycobacterium avium-intracellulare`, `Kaposis sarcoma`, `Cytomegalovirus`, `Other`) %>%
tbl_summary(#table_1,
            missing = "no",
            by = gender,
...
table_1 <- final_dataset %>%
  ...
  dplyr::select(`Age at enrolment`, gender, Ethnicity, `Duration of current illness`, `Opportunistic infection present`, `log10 viral load`, `Total CD4 count...10`, Sodium, Potassium, Haemoglobin, `White cell count`, `Lymphocyte count`, Neutrophils, `Addisons disease`, `Tuberculosis`, `Cryptococcus neoformans`, `Toxoplasmosis`, `Mycobacterium avium-intracellulare`, `Kaposis sarcoma`, `Cytomegalovirus`, `Other`) %>%
tbl_summary(#table_1,
            missing = "no",
            by = gender,
            # statistic = list(all_continuous() ~ "{mean} ({sd})"),
