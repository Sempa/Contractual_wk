...
dt03 <- bind_rows(read_delim("list of drugs - updated 23 April24.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE) %>%
      dplyr::select(-total),
    read_delim("list of drugs_additional_patients + CKD.csv", 
    delim = ";", escape_double = FALSE, trim_ws = TRUE)) %>%
  group_by(id) %>%
  ...
  dplyr::select(id, `ART exposure`, `Kidney medication`)
