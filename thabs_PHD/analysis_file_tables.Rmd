...
# Table 1.1: Opportunistic infections by gender
```{r, message = FALSE, cache = TRUE, warning=FALSE, echo = FALSE, results='asis'}
...
# Table 3: Bivariate table (without imputed data)
...
# Table 3: Bivariate table with imputed data
...
# Table 4: Multivariate table (generated with imputed data)
