...
model2 <- train(mortality ~ .,
  data = completeData_mort %>% dplyr::select(mortality, var_selected) %>% mutate(Random_cortisol = Random_cortisol/50, BP_systolic = BP_systolic/10),
  method = "glm",
  # metric = 'ROC',
  trControl = tc,
