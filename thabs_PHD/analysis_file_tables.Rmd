...
table_12 <- final_dataset %>%
  ...
  dplyr::select(`Age at enrolment, median (IQR) (years)`, `Gender, n(%)`, `Duration of current illness, median (IQR) (days)`,
...
`White cell count X109`, `Lymphocyte count X109`, Neutrophils, `ART exposure`, `TB medication`,
`Fungal medication`, `Parvo B19`, `COVID-19`, Neurocysticercosis, `Kidney medication`, `Fungal medication`, 
Rifampicin, Fluconazole, Opiates
    ) %>%# ,
tbl_summary(#table_1,
            missing = "no",
            by = `CD4 counts`,
