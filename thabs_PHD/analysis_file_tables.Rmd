...
Rifampicin, Fluconazole, Opiates, `CD4 counts`
    ) %>%# ,
tbl_summary(#table_1,
            missing = "no",
            by = `CD4 counts`,
...
`Duration of current illness, median (IQR) (days)` = `Duration of current illness`, 
`Weight loss`, `Random cortisol` = `Random cortisol result`, `Basal cortisol` = `Synacthen: 0 minute cortisol result`, `Stimulated cortisol` = `Synacthen: 30 minute cortisol result`, incremental_cortisol, `Viral load (log10 Copies/mL)` = `log10 viral load`, 
...
`Random cortisol`, `Basal cortisol`, `Stimulated cortisol`, incremental_cortisol, PTB, `White cell count X109`,
