...
positive_prevalence <- 0.124         # accurate test set prevalence
...
ggsave("Figure3_ConfusionMatrix.png", fig3, width = 8, height = 6.5, dpi = 600, bg = "white")
ggsave("Figure4_ROC.png", fig4, width = 8, height = 6.5, dpi = 600, bg = "white")
ggsave("Figure5_FeatureImportance.png", fig5, width = 10, height = 8, dpi = 600, bg = "white")
ggsave("Figures_Combined_ABC.png", combined_fig, width = 8.5, height = 11, dpi = 600, bg = "white")
